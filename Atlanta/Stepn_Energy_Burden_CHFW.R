...
save_path <- file.path(routine_path, city_to_run, "CHFW_one_year.rds")

save_path2 <- file.path(routine_path, city_to_run, "CHFW_one_year_bill.rds")
...
#file_path <- "D:/Umich_Project/Experiments/Seattle/Seattle_random.csv"
