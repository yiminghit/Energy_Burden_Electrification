...
save_path <- file.path(routine_path, city_to_run, "FHHW_one_year.rds")
save_path2 <- file.path(routine_path, city_to_run, "FHHW_one_year_bill.rds")
#save_path <- file.path("C:/Users/yangl11/R_Project/ACS_DATA", city_to_run, "FHHW_one_year.rds")
...
output_csv_path <- file.path(root_dir, paste('energy_bills2_', city_to_run, '.csv', sep=""))
