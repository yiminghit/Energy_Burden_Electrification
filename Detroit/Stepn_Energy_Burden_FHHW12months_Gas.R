...
save_path <- file.path(routine_path, city_to_run, "FHHW12months_Gas.rds")
###
## Base data wrangling
###
...
## RCM for net demand
###
filtered_results_setback <- results_setback[results_setback$building_characteristics_report.heating_fuel %in% c( "Natural Gas"), ]
