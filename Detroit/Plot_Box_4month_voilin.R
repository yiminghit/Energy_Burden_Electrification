...
file_path1 <- file.path(output_path,  "Figures", paste(city,"_box_plot_4months_all.png", sep=""))
...
summary_csv_path <- file.path(output_path, "montly_summary_stats.csv")
...
#dev.off()
ggsave(file_path1, plot= final_plot, width = 20, height = 3.5, dpi  = 600)
