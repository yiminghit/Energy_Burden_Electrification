...
save_path <- file.path(routine_path, city_to_run, "CHHW12months_Propane.rds")
...
###
filtered_results_setback <- results_setback[results_setback$building_characteristics_report.heating_fuel %in% c( "Fuel Oil", "Propane"), ]
