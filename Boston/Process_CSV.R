...
file_path1 <- paste0(routine1, city_name, "/ACSST5Y2017.S2503-2023-06-28T150545.csv")
file_path2 <- paste0(routine1, city_name, "/AHS TABLE3 6_28_2023.csv")
file_path3 <- paste0(routine1, city_name, "/AHS TABLE2 6_28_2023.csv")
