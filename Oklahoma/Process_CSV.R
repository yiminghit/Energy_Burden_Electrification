...
file_path1 <- paste0(routine1, city_name, "/ACSST5Y2017.S2503-2024-12-04T230533.csv")
file_path2 <- paste0(routine1, city_name, "/AHS TABLE3 12_4_2024.csv")
file_path3 <- paste0(routine1, city_name, "/AHS TABLE2 12_4_2024.csv")
