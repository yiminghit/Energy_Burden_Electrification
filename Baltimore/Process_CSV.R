...
file_path1 <- paste0(routine1, city_name, "/ACSST5Y2017.S2503-2023-06-24T231338.csv")
file_path2 <- paste0(routine1, city_name, "/AHS TABLE3 6_24_2023.csv")
file_path3 <- paste0(routine1, city_name, "/AHS TABLE2 6_24_2023.csv")
...
subset_df2 <- df2[c( 61, 67,75), 1:2]
subset_df3 <- df3[56:65, 1:2]
...
agg2_number1 <- as.numeric(gsub(",", "", subset_df2$number[1]))
