...
def get_table(df, targets):
  ...
  #  shape = tuple([df[c].unique().shape[0] for c in factors])
   # aaa=cross_tab.values
    ...
    ini_data = robjects.r['readRDS']('Phoenix_income_ini.rds')
...
f, u_name, u, X = get_table(df, {
    'House Size': {'0-1499':0.437079072087802, '1500-2499':0.393676727363432, '2500-3499':0.102332252432028, '3500+':0.0669119481167374},
    #'House Bedroom': {'1': 0.09726210989, '2': 0.21740379092,'3':0.42188397472,'4 or more': 0.26345012445},
    'AC type': {'Central':0.960427172945713, 'Room':0.0173835657075052, 'None':0.0221892613467814},
    'Income':{'<15k':0.0730492514202754, '15k-34999':0.129479737762285, '35k-74999':0.292479853155467, '75k-99999':0.140099667506622, '>100k':0.364891490155351
}
})
