...
file_path1 <- paste0(routine1, city_name, "/Phoenix_income_ini.rds")
# Read the CSV file
data <- read_csv("C:/Users/yimin/Dropbox/R_Project/ACS_DATA/MicroData/2017_nationaldata.csv")
#data <- read_csv("C:/Users/yimin/Dropbox/R_Project/ACS_DATA/MicroData/2017_microdata.csv")
region_code <- "'38060'"
#12580 baltimore
#42660 Seattle
