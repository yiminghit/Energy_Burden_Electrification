...
file_path1 <- paste0(routine1, city_name, "/Orlando_data.rds")
# Read the CSV file
data <- read_csv("C:/Users/yangl11/R_Project/ACS_DATA/MicroData/2017_nationaldata.csv")
region_code <- "'33100'"
#12580 baltimore
#42660 Seattle
...
filtered_data$UNITSIZE[filtered_data$UNITSIZE == "'1'"] <- "<500"
filtered_data$UNITSIZE[filtered_data$UNITSIZE == "'2'"] <- "500-749"
filtered_data$UNITSIZE[filtered_data$UNITSIZE == "'3'"] <- "750-999"
filtered_data$UNITSIZE[filtered_data$UNITSIZE == "'4'"] <- "1k-1499"
filtered_data$UNITSIZE[filtered_data$UNITSIZE == "'5'"] <- "1.5k-1999"
filtered_data$UNITSIZE[filtered_data$UNITSIZE == "'6'"] <- "2k-2499"
filtered_data$UNITSIZE[filtered_data$UNITSIZE == "'7'"] <- "2.5k-2999"
filtered_data$UNITSIZE[filtered_data$UNITSIZE == "'8'"] <- "3k-3999"
filtered_data$UNITSIZE[filtered_data$UNITSIZE == "'9'"] <- ">4k"
...
set2 <- c( "<500","500-749","750-999","1k-1499","1.5k-1999","2k-2499","2.5k-2999","3k-3999",">4k")
...
u_name <- list(
  c('<500', '500-749', '750-999', '1k-1,499', '1.5k-1,999', '2k-2,499', '2.5k-2,999', '3k-3,999', '4k or more'),
  c('Central', 'Room', 'None'),
